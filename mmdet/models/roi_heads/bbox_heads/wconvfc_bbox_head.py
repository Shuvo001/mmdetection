...
class WConvFCBBoxHead(BBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(WConvFCBBoxHead, self).__init__(
...
@HEADS.register_module()
class WShared2FCBBoxHead(WConvFCBBoxHead):
...
@HEADS.register_module()
class WShared4Conv1FCBBoxHead(WConvFCBBoxHead):
...
@HEADS.register_module()
class WShared4Conv2FCBBoxHead(WConvFCBBoxHead):
