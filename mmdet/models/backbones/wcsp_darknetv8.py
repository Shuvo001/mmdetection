...
class YOLOv8CSPDarknet(YOLOBaseBackbone):
    ...
    def build_stem_layer(self) -> nn.Module:
        """Build a stem layer."""
        if self.deep_stem:
            return self.build_deep_stem_layer(self.input_channels,
    ...
    def build_deep_stem_layer(self,in_channels,stem_channels,activation_fn="LeakyReLU"):
        return build_stem(self.deep_stem_mode,in_channels,int(stem_channels),activation_fn=activation_fn)
