...
from .wresnet import MultiBranchStem12X, MultiBranchStemS12X, MultiBranchStemSBN12X, MultiBranchStemS4X,MultiBranchStemSL12X
...
class WCSPDarknet(BaseModule):
    ...
    def __init__(self,
        ...
        stem_channels = int(arch_setting[0][0] * widen_factor)
        self.stem = self._make_deep_stem_layer(in_channels,
                                               stem_channels,
                                               activation_fn=stem_activation_fn,
                                               norm_cfg=norm_cfg)
    ...
    def _make_deep_stem_layer(self,in_channels,stem_channels,activation_fn="ReLU",norm_cfg=None,conv_cfg=None):
        ...
        elif self.deep_stem_mode == "MultiBranchStemSBN12X":
            return MultiBranchStemSBN12X(in_channels,stem_channels,activation_fn=activation_fn)
