...
model = dict(
    ...
    roi_head=dict(
        ...
        drop_blocks={ "dropout":{"type":"DropBlock2D","drop_prob":0.4,"block_size":[4,4,3,2]},
...
work_dir="/home/wj/ai/mldata1/B7mura/workdir/b7mura_faster_yoloxv2_dy"
