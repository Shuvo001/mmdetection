#与sn相比，使用了su1数据集, WShared4Conv2FCBBoxHead不使用norm, ResNeSt backbone
_base_ = [
...
work_dir="/home/wj/ai/mldata1/B7mura/workdir/b7mura_faster_s50"
load_from='cascade_mask_rcnn_s50_fpn_syncbn-backbone+head_mstrain_1x_coco_20201122_104428-99eca4c7.pth'
