#与sn相比，使用了su1数据集, WShared4Conv2FCBBoxHead不使用norm, WS+GN backbone
_base_ = [
...
work_dir="/home/wj/ai/mldata1/B7mura/workdir/b7mura_faster_ws"
load_from='mask_rcnn_r50_fpn_gn_ws-all_20_23_24e_coco_20200213-487d1283.pth'
