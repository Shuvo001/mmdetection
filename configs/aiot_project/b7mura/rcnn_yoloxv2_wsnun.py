#与sn相比，使用了su1数据集, WShared4Conv2FCBBoxHead不使用norm, 及新的rsb预训练权重
_base_ = [
...
work_dir="/home/wj/ai/mldata1/B7mura/workdir/b7mura_faster_yoloxv2_wsnun"
load_from='cascade_mask_rcnn_r50_fpn_rsb-pretrain_1x_coco_20220113_193636-8b9ad50f.pth'
